 ...
 */
contract Cellow is IChannel, IDeposit, IChannelReader, EIP712 {
    ...
    constructor(IVerifier _verifier, IHasher _hasher, uint256 _denomination, uint32 _merkleTreeHeight)
        EIP712("Nitrolite:Custody", "0.3.0")
    ...
    /**
     * @notice Finalize the channel with a mutually created transition state proof
     * @param channelId Unique identifier for the channel
